...
class QSPIServiceService(erpc.server.Service):
    def __init__(self, handler):
        ...
        self._methods = {
                ...
                interface.IQSPIService.CHANGEFREQUENCY_ID: self._handle_changeFrequency,
            }
    ...
    def _handle_changeFrequency(self, sequence, codec):
        # Read incoming parameters.
        prescaler = codec.read_uint8()

        # Invoke user implementation of remote function.
        _result = self._handler.changeFrequency(prescaler)
        ...
        codec.start_write_message(erpc.codec.MessageInfo(
            type=erpc.codec.MessageType.kReplyMessage,
            service=interface.IQSPIService.SERVICE_ID,
            request=interface.IQSPIService.CHANGEFREQUENCY_ID,
            sequence=sequence))
        codec.write_int32(_result)
